...
public class RedisConfig {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        cacheConfigurations.put(AUTHORITY_CACHE, defaultCacheConfig.entryTtl(Duration.ofHours(24)));
        cacheConfigurations.put(APPLICATION_CACHE, defaultCacheConfig.entryTtl(Duration.ofMinutes(5)));
